...
translations <- list(
  pt = list(
    ...
    reports = "Relatórios", report_title = "Relatório territorial de previsão", report_download_html = "Exportar HTML",
  ...
  es = list(
    ...
    reports = "Informes", report_title = "Informe territorial de pronóstico", report_download_html = "Exportar HTML",
  ...
  fr = list(
    ...
    reports = "Rapports", report_title = "Rapport territorial de prévision", report_download_html = "Exporter en HTML",
  ...
  en = list(
    ...
    reports = "Reports", report_title = "Territorial forecast report", report_download_html = "Export HTML",
