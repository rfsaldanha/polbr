...
translations <- list(
  pt = list(
    ...
    minimize_panel = "Minimizar painel", restore_panel = "Restaurar painel",
  ...
  es = list(
    ...
    minimize_panel = "Minimizar panel", restore_panel = "Restaurar panel",
  ...
  fr = list(
    ...
    minimize_panel = "Réduire le panneau", restore_panel = "Restaurer le panneau",
  ...
  en = list(
    ...
    minimize_panel = "Minimize panel", restore_panel = "Restore panel",
